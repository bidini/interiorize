...
from interiorize.poincare import dynamical, gravity
...
sma     = 6.709e10  # Semi-major axis (cm) 
H       = 120e5     # Ocean thickness (cm)
rhow    = 1.0       # Ocean density
...
dyn = dynamical(cheb, om, Om, Mj, ms, sma, Rp,
                l=L, m=M, tau=tau, x0=a, xr=b)

# Solve the linear problem
dyn.solve(kind='bvp') # flow down to the center
