...
N2_vec = np.linspace(1e-8, 2e-8, 200)
...
plot_dir = '/Users/benja/Documents/projects/titan_tides/models_stratification_H350/'
...
dill.dump([N2_vec, k2_vec, E_vec], file=open(plot_dir+'k2_Rc{}p_L{}_N{}{}_H{}.pickle'.format(int(eta*100), np.max(L), N, label,int(H/1e5)), 'wb') )
